...
control_delay([], [], 0);                       % Reset funkcji realizuj¹cej opóŸnienie
solution1_X = ode45(@(t, x)plant_TS_X(t, x, control_delay(t, controlhandle(:,1)), X0_X, U0_X, A_X, B_X, n, U0_, range_X), T, X0_, options);
[~, t_U1_X, U1_X] = control_delay([], [], 1);         % Przebieg sterowania
control_delay([], [], 0);                       % Reset funkcji realizuj¹cej opóŸnienie
solution2_X = ode45(@(t, x)plant_TS_X(t, x, control_delay(t, controlhandle(:,2)), X0_X, U0_X, A_X, B_X, n, U0_, range_X), T, X0_, options);
[~, t_U2_X, U2_X] = control_delay([], [], 1);         % Przebieg sterowania
control_delay([], [], 0);                       % Reset funkcji realizuj¹cej opóŸnienie
solution3_X = ode45(@(t, x)plant_TS_X(t, x, control_delay(t, controlhandle(:,3)), X0_X, U0_X, A_X, B_X, n, U0_, range_X), T, X0_, options);
[~, t_U3_X, U3_X] = control_delay([], [], 1);         % Przebieg sterowania
control_delay([], [], 0);                       % Reset funkcji realizuj¹cej opóŸnienie
solution4_X = ode45(@(t, x)plant_TS_X(t, x, control_delay(t, controlhandle(:,4)), X0_X, U0_X, A_X, B_X, n, U0_, range_X), T, X0_, options);
[~, t_U4_X, U4_X] = control_delay([], [], 1);         % Przebieg sterowania


% Obiekt rozmyty wzglêdem F
control_delay([], [], 0);                       % Reset funkcji realizuj¹cej opóŸnienie
solution1_U = ode45(@(t, x)plant_TS_U(t, x, control_delay(t, controlhandle(:,1)), X0_U, U0_U, A_U, B_U, n, U0_, range_U), T, X0_, options);
[~, t_U1_U, U1_U] = control_delay([], [], 1);         % Przebieg sterowania
control_delay([], [], 0);                       % Reset funkcji realizuj¹cej opóŸnienie
solution2_U = ode45(@(t, x)plant_TS_U(t, x, control_delay(t, controlhandle(:,2)), X0_U, U0_U, A_U, B_U, n, U0_, range_U), T, X0_, options);
[~, t_U2_U, U2_U] = control_delay([], [], 1);         % Przebieg sterowania
control_delay([], [], 0);                       % Reset funkcji realizuj¹cej opóŸnienie
solution3_U = ode45(@(t, x)plant_TS_U(t, x, control_delay(t, controlhandle(:,3)), X0_U, U0_U, A_U, B_U, n, U0_, range_U), T, X0_, options);
[~, t_U3_U, U3_U] = control_delay([], [], 1);         % Przebieg sterowania
control_delay([], [], 0);                       % Reset funkcji realizuj¹cej opóŸnienie
solution4_U = ode45(@(t, x)plant_TS_U(t, x, control_delay(t, controlhandle(:,4)), X0_U, U0_U, A_U, B_U, n, U0_, range_U), T, X0_, options);
