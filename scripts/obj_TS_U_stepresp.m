%%%%% OdpowiedŸ skokowa modelu rozmytego wzglêdem wartoœci sterowania F1
...
% skrajne modele s¹ wyznaczone wokó³ punktów F_pracy_min/max = F_0 -/ +rng * F0
n = 5;                                                  % liczba punktów pracy
rng = 0.5;                                              % zakres rozmywania
[A, B, X0, U0, range] = linAB_TS_U(data, n, rng);       % A, B, X0, U0 - parametry n zlinearyzowanych uk³adów
